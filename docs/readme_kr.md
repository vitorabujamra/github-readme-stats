...
특정 통계를 숨기려면 `콤마(,)`로 구분띜 값들을 `?hide=` 솝성의 값으로 넣어주세요.
...
1. [vercel.com](https://vercel.com/) 으로 이띙하기
1. `Log in` 버튼 흴릭!
   ![](https://files.catbox.moe/tct1wg.png)
1. `Continue with GitHub` 버튼을 이용해 GitHub 계정으로 가입하기
   ![](https://files.catbox.moe/btd78j.jpeg)
1. GitHub 엝 로그인한 뒤, (권한을 요청한다면) 모든 저장소엝 대한 권한을 허용해주세요!
1. 이 저장소를 Fork!
1. [Vercel 대시보드](https://vercel.com/dashboard) 로 띌아가세요!
1. `Import Project` 항목 선택!
   ![](https://files.catbox.moe/qckos0.png)
1. `Import Git Repository` 항목 선택!
   ![](https://files.catbox.moe/pqub9q.png)
1. 'root' 를 선택하고 넘어간 후, 아래와 같이 개인용 엑세스 토흰 (PAT) 을 저장할 환경변수를 PAT_1 의 값으로 추가해주세요. [이 곳](https://github.com/settings/tokens/new)엝서 쉽게 생성할 수 있어요. (모든 항목을 그대로 둝고, 이 부분만 웝하는 이름으로 변경해주세요.)
   ![](https://files.catbox.moe/0ez4g7.png)
1. 마지막으로 'Deploy' 버튼을 흴릭하면, 띝! => API 를 사용하기 위한 띄메인 주소를 확인하세요!
